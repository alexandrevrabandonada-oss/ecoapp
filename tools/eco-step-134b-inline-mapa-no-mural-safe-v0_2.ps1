...
$me = "eco-step-134b-inline-mapa-no-mural-safe-v0_2"
...
# cria componente (SEM backticks, SEM template string)
$compLines = @(
...
for ($i=0; $i -lt $lines.Count; $i++) {
  if ($lines[$i] -match "import\s+MuralInlineMapa\s+from") { $hasImport = $true }
