...
$me = "eco-step-133-mapa-panel-iframe-actions-and-wide-v0_1"
...
# =========================================================
# PATCH 1) Reescrever MuralReadableStyles.tsx (safe, sem escapes problemáticos)
# =========================================================
$stylesPath = Join-Path $Root "src\app\eco\mural\_components\MuralReadableStyles.tsx"
$styles = @(
  "/* AUTO-GENERATED by tools/" + $me + ".ps1 */",
  "",
  "const css = [",
  "  \".eco-mural { background: #070b08 !important; color: #eaeaea !important; min-height: 100vh !important; padding: 18px 0 120px !important; }\",",
  "  \".eco-mural * { text-rendering: geometricPrecision; }\",",
  "  \".eco-mural-inner { width: min(1400px, calc(100% - 48px)) !important; margin: 0 auto !important; background: #f6f6f6 !important; color: #111 !important; border: 1px solid #111 !important; border-radius: 18px !important; padding: 20px !important; }\",",
  "  \".eco-mural h1 { font-size: 28px !important; line-height: 1.1 !important; font-weight: 900 !important; letter-spacing: -0.02em !important; margin: 10px 0 8px 0 !important; }\",",
  "  \".eco-mural h2 { font-size: 18px !important; font-weight: 900 !important; margin: 10px 0 8px 0 !important; }\",",
  "  \".eco-mural p { font-size: 14px !important; }\",",
  "  \".eco-mural a { color: #0b5 !important; text-decoration: underline !important; }\",",
  "  \".eco-mural button { font-size: 14px !important; font-weight: 900 !important; border: 1px solid #111 !important; border-radius: 12px !important; background: #fff !important; padding: 10px 12px !important; }\",",
  ...
  "  \".eco-mural [role=\\\"button\\\"] { border: 1px solid #111 !important; border-radius: 12px !important; }\",",
  "  \"@media (max-width: 980px) { .eco-mural-inner { width: calc(100% - 24px) !important; padding: 16px !important; } }\",",
  "].join(\\\"\\\\n\\\");",
  "",
...
BackupAndWrite $stylesPath $styles

# =========================================================
# PATCH 2) Garantir /eco/mapa como painel (lista + iframe OSM + ações)
# =========================================================
...
BackupAndWrite $mapaClientPath $mapaClient
...
BackupAndWrite $mapaPagePath $mapaPage
...
$report += "- Patched:"
$report += "  - src/app/eco/mural/_components/MuralReadableStyles.tsx (wide+legível, safe TSX)"
$report += "  - src/app/eco/mapa/page.tsx (painel do mapa)"
$report += "  - src/app/eco/mapa/_components/MapaClient.tsx (lista + iframe OSM + ações ✅🤝♻️)"
$report += ""
$report += "## Verify"
$report += "1) Ctrl+C -> npm run dev"
$report += "2) abrir /eco/mural (deve ficar bem mais largo e legível)"
$report += "3) abrir /eco/mapa (lista à esquerda; mapa à direita; botões ✅🤝♻️ funcionam)"
$report += ""
