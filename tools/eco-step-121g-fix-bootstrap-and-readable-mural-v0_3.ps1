...
$me = "eco-step-121g-fix-bootstrap-and-readable-mural-v0_3"
...
# (1) Overwrite tools/_bootstrap.ps1 (corrigido)
...
# (2) Fix src/app/eco/mural/_components/MuralReadableStyles.tsx (sem crase/backtick)
...
$r += ""
$r += "## Patched"
$r += "- tools/_bootstrap.ps1 (fix aspas)"
$r += "- src/app/eco/mural/_components/MuralReadableStyles.tsx (css legível)"
$r += "- src/app/eco/mural/page.tsx (eco-mural + style inject)"
$r += ""
$r += "## Verify"
$r += "1) Ctrl+C -> npm run dev"
$r += "2) abrir /eco/mural (deve ficar legível)"
