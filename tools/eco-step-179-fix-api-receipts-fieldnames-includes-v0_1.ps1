...
$targetRel = "src\app\api\receipts\[code]\route.ts"
...
$bakDir = Join-Path $repoRoot ("tools\_patch_backup\eco-step-179\" + $stamp)
EnsureDir $bakDir

$reportPath = Join-Path $repoRoot ("reports\eco-step-179-fix-api-receipts-fieldnames-includes-" + $stamp + ".md")
...
$r = @()
$r += ("# eco-step-179 — fix api/receipts/[code] fieldNames.includes — " + $stamp)
$r += ""
$r += "## DIAG"
$r += ("alvo: " + $targetRel)
