...
Write-Host ("== eco-step-100-fix-list2-confirm-groupby-field-v0_2 == " + $ts)
...
$backupDir = Join-Path $Root ("tools/_patch_backup/" + $ts + "-eco-step-100-fix-list2-confirm-groupby-field-v0_2")
...
$rep = Join-Path $reportDir ("eco-step-100-fix-list2-confirm-groupby-field-v0_2-" + $ts + ".md")
$repText = @(
  "# eco-step-100-fix-list2-confirm-groupby-field-v0_2",
  "",
  "- Time: " + $ts,
  "- Backup: " + $backupDir,
  "",
