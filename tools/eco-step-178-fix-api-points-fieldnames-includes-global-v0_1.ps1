...
$bakDir = Join-Path $repoRoot ("tools\_patch_backup\eco-step-178\" + $stamp)
EnsureDir $bakDir

$reportPath = Join-Path $repoRoot ("reports\eco-step-178-fix-api-points-fieldnames-includes-global-" + $stamp + ".md")
...
$r = @()
$r += ("# eco-step-178 — fix api/points fieldNames.includes global — " + $stamp)
$r += ""
$r += "## DIAG"
$r += ("alvo: " + $targetRel)
