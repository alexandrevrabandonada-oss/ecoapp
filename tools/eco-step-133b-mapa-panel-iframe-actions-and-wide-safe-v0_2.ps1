...
$me = "eco-step-133b-mapa-panel-iframe-actions-and-wide-safe-v0_2"
...
# ================================
# PATCH 1) MuralReadableStyles.tsx (wide + legível)
# ================================
$stylesPath = Join-Path $Root "src\app\eco\mural\_components\MuralReadableStyles.tsx"
$ts = @(
/* AUTO-GENERATED by tools/eco-step-133b */
...
BackupAndWrite $stylesPath $ts

# ================================
# PATCH 2) /eco/mapa painel (lista + iframe OSM + ações)
# ================================
...
$r += "2) abrir /eco/mural (mais largo e legível)"
$r += "3) abrir /eco/mapa (lista + iframe + botões ✅🤝♻️)"
