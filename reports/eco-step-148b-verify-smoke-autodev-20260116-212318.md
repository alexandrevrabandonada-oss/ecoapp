# eco-step-148b — verify + smoke (auto dev) — 20260116-212318
...
(node:19208) ESLintIgnoreWarning: The ".eslintignore" file is no longer supported. Switch to using the "ignores" property in "eslint.config.js": https://eslint.org/docs/latest/use/configure/migration-guide#ignoring-files
...
> next build
 ...
 Ô£ô Generating static pages using 11 workers (44/44) in 828.6ms
